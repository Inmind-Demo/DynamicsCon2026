page 50003 "My Purchase Requisitions"
{
    ...
    layout
    {
        area(Content)
        {
            repeater(Lines)
            {
                ...
                {
                    ApplicationArea = All;
                    ToolTip = 'Specifies the rejection reason if the requisition was rejected.';
                    Visible = false;
                }
    ...
    trigger OnOpenPage()
    begin
        Rec.SetRange("Requested By", CopyStr(UserId(), 1, 50));
    end;
